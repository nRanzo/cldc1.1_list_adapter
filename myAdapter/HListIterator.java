...
/**
 * HListIterator interface that defines the methods of the list iterator.
 * Extends the HIterator interface and adds operations for iterating forward and backward in the list.
 */
public interface HListIterator extends HIterator {

    /**
     * Inserts the specified element into the list immediately before the element that would be
     * returned by the next call to {@code next()}.
     *
